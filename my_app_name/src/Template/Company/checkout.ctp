...
<link href="/assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <?php echo $this->Html->css('form-validation')?>
...
<div class="container">
  <main>
    <div class="py-5 text-center">
        <?php echo $this->Html->image('/assets/brand/bootstrap-logo.svg', ['alt' => '','width'=>"72", 'height'=>"57"])?>
        ...
        <?= $this->Form->create() ?>
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="firstName" placeholder="" value="frank" name="firtname">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="address" placeholder="1234 Main St"  name="adress">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="address2" placeholder="Apartment or suite"  name="adress2">
            </div>
